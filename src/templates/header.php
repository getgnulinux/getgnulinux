    ...
    <nav>
      <div class="nav-wrapper">
        ...
        <ul class="right">
          ...
          <li>
            <a class="btn-floating btn-flat waves-effect waves-light MuiButtonBase-root MuiIconButton-root MuiIconButton-colorInherit" href="<?php $this->text('project_url'); ?>" title="<?php print _("GitHub repository"); ?>" target="_blank">
