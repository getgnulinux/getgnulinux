...
class GetGNULinux {
    ...
    public $config = array(
        ...
        'locales' => array(
            ...
            'ca' => array('ca_AD.UTF-8',"Català", 0.57),
            'da' => array('da_DK.UTF-8',"Dansk", 0.05),
            'de' => array('de_DE.UTF-8',"Deutsch", 0.47),
            'en' => array('en_US.UTF-8',"English", 1),
            'eo' => array('eo.UTF-8'   ,"Esperanto", 0.24),
            'es' => array('es_ES.UTF-8',"Español", 0.66),
            'fr' => array('fr_FR.UTF-8',"Français", 0.71),
            'he' => array('he_IL.UTF-8',"עִבְרִית", 1),
            'hr' => array('hr_HR.UTF-8',"Hrvatski", 0.13),
            'ia' => array('ia'         ,"Interlingua", 0.24),
            'it' => array('it_IT.UTF-8',"Italiano", 0.37),
            'ja' => array('ja_JP.UTF-8',"日本語", 0),
            'ml' => array('ml_IN'      ,"മലയാളം", 0.16),
            'nl' => array('nl_NL.UTF-8',"Nederlands", 0.32),
            'pt' => array('pt_PT.UTF-8',"Português", 0.18),
            'ru' => array('ru_RU.UTF-8',"Русский", 0.62),
            'sr' => array('sr_RS'      ,"Српски", 0.06),
            'tr' => array('tr_TR.UTF-8',"Türkçe", 0.15),
            'uk' => array('uk_UA.UTF-8',"Українська", 0.42),
            'vi' => array('vi_VN'      ,"Tiếng Việt", 0.50),
            'zh' => array('zh_CN.UTF-8',"中文", 0.51),
            )
        );
