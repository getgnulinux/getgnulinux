...
class GetGnuLinux {
    ...
    var $config = array(
        ...
        'locales' => array(
            ...
            'eo' => array('eo.UTF-8',   'eo',"Home",'ltr',"Esperanto", "Watch this page in Esperanto", 0.23),
            'es' => array('es_ES.UTF-8','es',"Inicio",'ltr',"Español", "¡Lee esta página en español!", 0.66),
            'fr' => array('fr_FR.UTF-8','fr',"Accueil",'ltr',"Français", "Cette page en français", 0.71),
            'hr' => array('hr_HR.UTF-8','hr',"Home",'ltr',"Hrvatski", "Watch this page in Croatian", 0.13),
            'ia' => array('ia',         'ia',"Home",'ltr',"Interlingua", "Watch this page in Interlingua", 0.06),
            'it' => array('it_IT.UTF-8','it',"Home",'ltr',"Italiano", "Watch this page in Italian", 0.37),
            ...
            'uk' => array('uk_UA.UTF-8','ua',"Додому",'ltr',"Українська", "Переглянути цю сторінку на українська мові!", 0.26),
