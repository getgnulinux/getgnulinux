...
class GetGnuLinux {
    ...
    var $config = array(
        ...
        'locales' => array(
            ...
            'da' => array('da_DK.UTF-8','dk',"Home",'ltr',"dansk sprog", "Watch this page in Danish", 0.05),
            ...
            'es' => array('es_ES.UTF-8','es',"Inicio",'ltr',"castellano", "¡Lee esta página en castellano!", 0.62),
            'fr' => array('fr_FR.UTF-8','fr',"Accueil",'ltr',"français", "Cette page en français", 0.64),
            'hr' => array('hr_HR.UTF-8','hr',"Home",'ltr',"hrvatski jezik", "Watch this page in Croatian", 0.13),
            ...
            'ru' => array('ru_RU.UTF-8','ru',"Домой",'ltr',"русский", "Просмотреть эту страницу на русский языке!", 0.62),
            ...
            'zh' => array('zh_CN.UTF-8','cn',"Home",'ltr',"汉语", "Watch this page in Chinese", 0.42),
            )
        );
