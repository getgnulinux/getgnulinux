...
<?php print _("About 3 million computers get sold every year in China, but
people don't pay for the software.<br />
Someday they will, though. As long as they are going to steal it [sic], we want
them to steal ours. They'll get sort of addicted, and then we'll somehow figure
out how to collect sometime in the next decade."); ?>
<span class="source"><span class="author">Bill Gates,</span> <a href="http://news.com.com/2100-1023-212942.html"><?php print _("1998 interview"); ?></a></span>
...
<li>
    ...
    <p><?php print _("Sticking to Microsoft standards is not an easy job &ndash;
unless you can afford to upgrade very often. Ever tried to work on the same
<code>.doc</code> file with both an Office 95 and an Office 97 computer? You'll
know what we mean."); ?></p>
...
<a href=\"http://www.pidgin.im/\">instant messaging program</a> or other, will
come pre-installed on most computers you can buy."); ?></p>
</li>

</ul>

<p><?php print _("It is a good thing to propose a wide range of software and
services like Microsoft do; however, designing and combining them to shut users
from non-Microsoft peers is unethical. It's not technically hard to adopt more
open formats. But it means your customers are <em>free to choose what they do
with their work</em> &ndash; Microsoft isn't there yet."); ?></p>
