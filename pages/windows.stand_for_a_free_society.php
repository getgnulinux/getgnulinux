...
print _("I come up with new words, phrases, analogies, all kinds of fun stuff in the English language and people paraphrase what I had to say and make money talking about some of the same things that I did."); ?><br />
<?php print _("<strong>If I try to lock down</strong> what I talk about and write about, the same way as a proprietary software company does, then the whole industry of speaking, writing, media, would be overly litigious, and transaction costs would be prohibitive."); ?>
...
print _("Though no one has a proprietary lock on yoga, it is still a thriving $30 billion business in the United States."); ?></div>
...
print _("Many cultural products are now emerging &quot;triple protected&quot;, not only by copyright and code, but also by contracts or licenses for which users waive all remaining rights."); ?><br />
<?php print _("Increasingly, copyright is replaced with click-through end-user licenses for digital content, using contract law to establish the absolute property rights that copyright laws were originally intended to deny to publishers."); ?>
...
<p><?php
# i18n: This describes the last link, which will automatically point to the 'Misunderstanding Free Software' article
