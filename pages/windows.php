...
<p><a href="<?php $this->base_url('windows/restrictions'); ?>" title="Restrictions in a proprietary software license."><img src="/images/windows/windows.windows1.png" width="115" height="95" alt="Restrictions"/></a>
...
<p><a href="<?php $this->base_url('windows/what_about_choice'); ?>" title="How Microsoft lock customers in."><img src="/images/windows/windows.windows2.png" width="115" height="95" alt="What about choice?"/></a>
...
<p><?php $p = _("Many people find that Windows, an otherwise decent piece of software, <strong>withdraws so many rights</strong> from them, that it is not worth them using it. Mac&nbsp;OS is <a href=\"%s#mac_freedom\">not much better</a>, either."); printf($p, $this->base_url('linux/linux_faq',1)); ?></p>
