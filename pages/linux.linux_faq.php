...
<div id="maincontent" class="linux_faq">
...
<div class="qa_series">
	...
	<h3 id="naming_conventions" class="question"><?php print _("Are &quot;GNU/Linux&quot; and &quot;Linux&quot; any different?"); ?></h3>

	<div class="question_sub"><?php
    # i18n: This is italic text just below the question, which elaborates a little on it.
    print _("You keep referring to one and the other alternatively. What is this all about?"); ?></div>
	<div class="answer"><p><?php print _("Originally, <strong>Linux</strong> refers to a core component (called the kernel) that fits within the <strong>GNU</strong> system. What users run today are, to be precise, \"<em>distributions of the GNU/Linux system</em>\"."); ?></p>
	...
	<div class="question_answer">
	<h3 id="gnu" class="question"><?php print _("And what has that software to do with a gnu?"); ?></h3>
	...
	<div class="question_answer">
	<h3 id="trademark" class="question"><?php print _("Is Linux a registered trademark?"); ?></h3>

	<div class="answer"><p><?php print _("Yes. You cannot sell any random software under the name of Linux&reg;. The trademark is held by <a href=\"http://www.linuxmark.org/\">the Linux Mark Institute</a>."); ?></p>
	</div>
	...
	<div class="question_answer">
	<h3 id="only_linux" class="question"><?php print _("Is GNU/Linux the only free operating system available?"); ?></h3>

	<div class="answer"><p><?php print _("No. GNU/Linux is by far the most widely used free system; however a number of other systems exist."); ?></p>
	...
	<div class="question_answer">
	<h3 id="mac" class="question"><?php print _("Is Mac OSX a distribution of Linux?"); ?></h3>
...
<div class="qa_series">
	...
	<div class="question_answer">
	<h3 id="open_source" class="question"><?php print _("Are &quot;Open Source&quot; and &quot;Free Software&quot; the same thing?"); ?></h3>

	<div class="answer"><p><?php print _("Yes and no."); ?></p>
	...
	<div class="question_answer">
	<h3 id="freedom" class="question"><?php print _("Why are some Linux distributions sold, not given away?"); ?></h3>

	<div class="question_sub"><?php
    # i18n: This is italic text just below the question, which elaborates a little on it.
    print _("Some websites actually <em>sell</em> distributions of Linux. So, why do you write it is \"free as speech and available at no charge\"?"); ?></div>
	<div class="answer"><p><?php
    # i18n: Use localized URL of free software definition on GNU.org in place of softwareliberty.com
	...
	<div class="question_answer">
	<h3 id="full_freedom" class="question"><?php print _("Why are some Linux distributions not fully free?"); ?></h3>

	<div class="question_sub"><?php
    # i18n: This is italic text just below the question, which elaborates a little on it.
    print _("Some Linux distributions are available at no charge, but include restrictive software. Why is it so?"); ?></div>
	<div class="answer"><p><?php print _("There are typically three types of policies regarding the inclusion of non-free software:"); ?></p>
	<ul>
	...
	<div class="question_answer">
	<h3 id="mac_freedom" class="question"><?php print _("Is Mac OS also a free operating system?"); ?></h3>

	<div class="question_sub"><?php print _("Do all the reasons for avoiding Windows apply to Mac&nbsp;OS?"); ?></div>
	<div class="answer"><p><?php $p = _("It's quite common for Mac users to believe they are exempt from <a href=\"%s\">restrictions associated with Windows</a>. Unfortunately such is not the case."); printf($p, $this->base_url('windows',1)); ?></p>
	...
	<div class="question_answer">
	<h3 id="linux_illegality" class="question"><?php print _("Aren't Linux users the ones who make illegal downloads?"); ?></h3>

	<div class="question_sub"><?php
    # i18n: This is italic text just below the question, which elaborates a little on it.
    print _("Isn't Linux about cracking, &quot;piracy&quot; and illegal download websites?"); ?></div>
	<div class="answer"><p><?php print _("No!"); ?></p>
	...
	<div class="question_answer">
	<h3 id="linux_communism" class="question"><?php print _("Is Linux a form of communism?"); ?></h3>

	<div class="question_sub"><?php
    # i18n: This is italic text just below the question, which elaborates a little on it.
    print _("\"Everything has to be free\" and \"No one owns anything\" sounds somewhat frightening. Are Linux and its <acronym title=\"GNU General Public License\">GPL</acronym> License something for anarchists or communists?"); ?></div>
	<div class="answer"><p><?php
...
<div class="qa_series">
	...
	<div class="question_answer">
	<h3 id="linux_pre-installed" class="question"><?php print _("Does Linux come pre-installed on computers?"); ?></h3>
	...
	<div class="question_answer">
	<h3 id="language" class="question"><?php print _("Can I get GNU/Linux in my own language?"); ?></h3>

	<div class="answer"><p><?php $url = $this->base_url('switch_to_linux/choose_a_distribution',1); $p = _("Yes. All main distributions, such as <a href=\"%s\">the ones we recommend</a>, are all available in the main languages around, and have support for many keyboard types."); printf($p, $url); ?></p>
	...
	<div class="question_answer">
	<h3 id="linux_legality" class="question"><?php print _("Is it legal to install Linux on my computer?"); ?></h3>

	<div class="question_sub"><?php
    # i18n: This is italic text just below the question, which elaborates a little on it.
    print _("There is a shiny Windows sticker on it! Am I allowed to erase Windows or use it together with Linux?"); ?></div>
	<div class="answer"><p><?php print _("<strong>Yes.</strong> It is absolutely, completely legal (providing of course it's your computer!)."); ?></p>
	...
	<div class="question_answer">
	<h3 id="new_computer" class="question"><?php print _("Do I have to purchase a new computer to run Linux?"); ?></h3>

	<div class="answer"><p><?php print _("Not at all. It will run happily on your own computer."); ?></p>
...
<div class="qa_series">
	...
	<div class="question_answer">
	<h3 id="ms_office" class="question"><?php print _("Will Microsoft Office run on Linux?"); ?></h3>
	...
	<p><a href="<?php
    # i18n: If it exists, please use the localized URL of OpenOffice.org . Else, please switch the URL to http://www.openoffice.org/
	print _("http://why.openoffice.org/") ?>"><img src="/images/linux/linux.faq.OpenOffice.org.png" alt="|| OpenOffice.org ||"/></a>
	...
	<div class="question_answer">
	<h3 id="dvd_mp3" class="question"><?php print _("Can I play my DVDs and MP3s under GNU/Linux?"); ?></h3>

	<div class="answer"><p><?php print _("The simple answer to this question would be &quot;yes&quot;, however this is only half the truth."); ?></p>
    ...
    <?php print _("Non-encrypted DVDs, which include most home-made DVDs, play perfectly well with only free software."); ?></p>
		...
		- <a href="<?php
        # i18n: If it exists, please use the localized URL of this wiki page (it's sometimes hard to find). Else, please leave the URL as such.
        print _("https://wiki.ubuntu.com/RestrictedFormats"); ?>"><?php print _("Ubuntu Restricted Formats"); ?></a><br/>
		- <a href="<?php
        # i18n: If it exists, please use the localized URL of this wiki page (it's sometimes hard to find). Else, please leave the URL as such.
        print _("http://www.fedoraproject.org/wiki/ForbiddenItems"); ?>"><?php print _("Fedora Forbidden Items"); ?></a><br/>
		</div><!-- end read_more -->
	</div>
