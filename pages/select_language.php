...
<p><?php # i18n: The linked debian.org web pages are multilingual and the correct language is automatically displayed using language negotiation. So it is recommended to keep these URLs as they are.
