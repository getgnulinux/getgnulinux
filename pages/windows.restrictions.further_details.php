...
<main role="main">
  <section>
    ...
    <ul>
      <li>
        <div class="highlight"><?php print _("It is unclear who can use, receive or buy your software."); ?></div>
      ...
      <li>
        <div class="highlight"><?php print _("You may not lease, lend or provide commercial hosting services with the software"); ?></div>
      ...
      <li>
        <div class="highlight"><?php print _("The upgrade is only valid for the first license you use it on"); ?></div>
      ...
      <li>
        <div class="highlight"><?php print _("Educational versions are crippled"); ?></div>
      ...
      <li>
        <div class="highlight"><?php print _("The components of the software may not be separated"); ?></div>
      ...
      <li>
        <div class="highlight"><?php print _("Private information is collected"); ?></div>
