...
<main role="main">
    <div class="maxwidth">
      ...
      <section>
        ...
        <div class="ubuntu_light">
            <div class="getit_box_left">
                <div class="getit_box_logo"><img src="/images/UbuntuIcon.png" height="60" alt="Ubuntu"/></div>
        ...
        <div class="fedora_light">
            <div class="getit_box_left">
                <div class="getit_box_logo"><img src="/images/FedoraIcon.png" height="60" alt="Fedora"/></div>
                <div class="getit_box_text">
        ...
        <div class="trisquel_light">
            <div class="getit_box_left">
                <div class="getit_box_logo"><img src="/images/TrisquelIcon.png" height="60" alt="Trisquel"/></div>
                <div class="getit_box_text">
      ...
      <section>
        ...
        <a href="http://linuxpreloaded.com/" title="Linux pre-installed computers"><img class="float-right" src="/images/Laptop.png" height="150" alt="Laptop"/></a>
