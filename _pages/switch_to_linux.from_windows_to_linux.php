...
It's also safe: you can forget the demo/trial crippled software, or harmful freeware polluting the web."); ?></li>
	...
	<img src="/images/switch_to_linux/switch_to_linux.from_windows_to_linux.preferences.png" width="100" height="69" alt="built solid"/>
...
Also, Linux lets you choose what you want and what you don't. If you had a hard time getting rid of MSN Messenger, Windows Update notifications, or Clippit the paperclip, you'll find it refreshing."); ?></li>
	...
	<img src="/images/switch_to_linux/switch_to_linux.from_windows_to_linux.security.png" width="100" height="69" alt="security"/>
...
<div class="note"><?php $p = _("See more: we have <a href=\"%s\">screenshots</a>.</div>"); printf($p, base_url('linux/screenshots',1)); ?></li>
	...
	<img src="/images/switch_to_linux/switch_to_linux.from_windows_to_linux.browsing.png" width="100" height="69" alt="Firefox browser"/>
    <?php print _("The Web looks just the same when viewed with Linux (in fact you can browse the Web with the same program if you already use <a href=\"http://www.getfirefox.com/\">Firefox</a>). And of course, you can go through your picture and music collection all the same. Files and folders are navigated with a file manager like Windows Explorer."); ?></li>
</ul>
...
<div class="quote">
<p><?php print _("&quot;Never tell the truth to people who are not worthy of it.&quot;"); ?> <span class="note">&mdash; Mark Twain;</span></p>
<p><em><?php print _("or:"); ?></em></p>
<p><?php print _("&quot;Tell the truth and run.&quot; <span class=\"note\">&mdash; Yugoslavian proverb."); ?></span></p>
</div>

<ul>
	<li><h3><?php print _("Driver support"); ?></h3>
	<img src="/images/switch_to_linux/switch_to_linux.from_windows_to_linux.hardware.png" width="100" height="69" alt="some hardware problems"/>
...
However, the vast majority of computers with standard hardware work out of the box with main Linux distributions. Common hardware such as USB keys or photo cameras never are a problem."); ?></li>
	...
	<img src="/images/switch_to_linux/switch_to_linux.from_windows_to_linux.dvd_restricted.png" width="100" height="69" alt="DVDs and restricted media"/>
...
This might lead you to circumvent the restrictions in some DVDs and the <acronym title=\"Digital Restrictions Management\">DRM</acronym> in some music files, even if you purchased them in full legality, to be make them work under Linux. Unfortunately, depending on where you live, <em>such circumvention processes may be illegal</em> even if you purchased your media entirely legally."); ?><br/>
	...
	<img src="/images/switch_to_linux/switch_to_linux.from_windows_to_linux.gaming.png" width="100" height="69" alt="gaming"/>
...
There is a very active free software game development community though, and they have produced quite a few high-quality games, both 2D and 3D, that are free software. You can head to the <a href=\"http://ubuntuforums.org/forumdisplay.php?f=93\">Ubuntu gaming forum</a> to find more information."); ?><br/>
	...
	<img src="/images/switch_to_linux/switch_to_linux.from_windows_to_linux.hibernation.png" width="100" height="69" alt="hibernation problems"/>
