...
<?php print _("If you go to most of the free software sites you can click down
a couple of levels and find the [GNU] <acronym title=\"General Public License,
the main free software license\">GPL</acronym>, the X license, the Apache
license, whichever terms and conditions you have to accept in order to use that
software.<br/>
...
<span class="source"><span class="author">Don Marti,</span> <a href="http://www.go-opensource.org/go_open/episode_2/big_guns/" hreflang="en" title="Don Marti interview"><?php print _("2005 interview"); ?></a></span>
</div></div></div>

<p><?php print _("A common mistake is for Windows and Office users to think
...
<ul>
	<li>
		...
		<p><?php print _("No one can buy Windows or Microsoft Office: instead
users <strong>purchase a permission to use</strong> them. The license describes
the terms of this permission. It is the restrictive legal text you have to
click \"OK\" to upon install."); ?></p>
	</li>
	<li>
...
<a href=\"%s\" title=\"a few more things about Mircrosoft licenses\">Reading the license and enumerating your remaining rights</a> is itself a difficult task."); printf($p, base_url('windows/restrictions/further_details',1)); ?></p>
	...
	<li>
		<div class="keypart"><?php print _("An <acronym title=\"Original Equipment Manufacturer (simply the hardware seller)\">OEM</acronym>-distributed software cannot be transferred to another computer."); ?></div>

		<p><?php print _("If you bought your computer with Windows or Office
pre-installed (the so-called OEM licenses, or the \"shrink wrap\" Windows discs),
...
that many violations occur everyday around us. People are tempted to buy only
one version of Microsoft Office and install it on two computers. Others
keep their version of Windows when they throw their PC away. Other people give
away their second-hand Windows software when they stop using it."); ?></p>

<p><?php print _("<strong>You have an alternative to breaking this law,</strong>
or feeling very restrained when you abide to it. GNU/Linux is
<a href=\"http://www.softwareliberty.com/\">Free Software</a> (much better than
just freeware): its <a href=\"http://www.gnu.org/copyleft/gpl.html\">GPL</a>
