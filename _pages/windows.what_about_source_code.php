...
<h1 class="windows_section_h1"><?php print _("What about<br/>source code?"); ?></h1>

<div class="quote1"><div class="quote2"><div class="quote3">
<?php print _("You might say, \"How do I change this recipe to take out the salt?\"
and the great chef would respond, \"How dare you insult my recipe, the child of
my brain and my palate, by trying to tamper with it? You don't have the judgment
to change my recipe and make it work right!\""); ?>
<span class="source"><span class="author">Richard Stallman,</span> <a href="http://www.gnu.org/philosophy/why-free.html">Why Software Should Be Free</a></span>
</div></div></div>
...
products work</strong>. Windows is very much like a car that only the original
manufacturer is allowed to service."); ?></p>
</li>
<li><h2 id="insecurity_means_business"><?php print _("Insecurity means business"); ?></h2>

<p><?php print _("Whenever a flaw in Windows is discovered, it is exploited,
which results in trojans, viruses, spyware and the likes. <strong>Such nuisances
...
exploiting them, if it is active and updated)."); ?></p>

<p><?php print _("Microsoft will today happily
<a href=\"http://onecare.live.com/standard/en-us/purchase/default.htm\" rel=\"nofollow\">sell
you their own protection over their own insecurities</a> &ndash; it sells the
poisoned apple and its antidote, separately."); ?></p>
...
<p><?php print _("It comes as no surprise that proprietary software is severely
lacking in terms of security, compared to software whose source code is freely
available (including GNU/Linux)."); ?></p>
