...
<main dir="ltr">
  <article>
    <div class="container">
      ...
      <p>The <a href="<?php $this->text('project_url'); ?>" rel="external" title="GitLab Project">source code</a> of the web application is licensed under the <a href="https://www.gnu.org/licenses/agpl-3.0.html" rel="external">GNU Affero General Public License Version 3</a>.</p>
      <p>Copyright <?php echo date("Y"); ?> <a href="https://gitlab.com/getgnulinux" rel="external">get GNU/Linux!</a></p>
      ...
      <ul class="browser-default">
        <li>Ubuntu, Fedora, and Debian logos: in accordance with the respective trademark guidelines (<a href="https://ubuntu.com/legal/intellectual-property-policy" rel="external">Ubuntu</a>, <a href="https://fedoraproject.org/wiki/Legal/TrademarkGuidelines" rel="external">Fedora</a>, <a href="https://www.debian.org/logos/" rel="external">Debian</a>)</li>
        <li>The computer image on the "Try or install" page is of Purism's <a href="https://puri.sm/products/librem-mini/" rel="external">Librem Mini</a> (<a href="https://creativecommons.org/licenses/by-sa/4.0/" rel="external">CC BY-SA 4.0</a>)</li>
        <li>LibreOffice logo by Christoph Noack (<a href="https://creativecommons.org/licenses/by-sa/3.0" title="Creative Commons Attribution-Share Alike 3.0" rel="external">CC BY-SA 3.0</a>, <a href="https://commons.wikimedia.org/w/index.php?curid=34369081" rel="external">Link</a>)</li>
      </ul>
      ...
      <ul class="browser-default">
        ...
        <li><a href="http://www.timj.co.uk/computing/politics-policy/drm/fallacy/" rel="external">The fallacy of DRM</a>, an article by Tim Jackson (derivative use with permission);</li>
        ...
        <li><a href="https://lessig.org/product/free-culture/" rel="external">Free Culture</a>, a book by Lawrence Lessig, <abbr title="Creative Commons">CC</abbr> <abbr title="Attribution, Non Commercial">BY-NC</abbr> license;</li>
