  ...
  <div class="container">
    <article id="faq">
      ...
      <section>
        ...
        <p><?php print _("No."); ?></p>
        <p><?php print _("It is technically possible to adapt Microsoft Office to GNU/Linux, but Microsoft isn't keen on allowing Office users to choose their operating system. There are other issues with MS Office and openness &mdash; like Microsoft's fierce opposition to supporting <a href=\"http://opendocumentfellowship.com/\" rel=\"external\">the OpenDocument format</a>."); ?></p>
        <p><?php print _("However, a complete, Free, reliable office suite exists: <a href=\"https://www.openoffice.org/\" rel=\"external\">OpenOffice.org</a>. Or you can choose its Open Source community-driven alternative, <a href=\"https://www.libreoffice.org/\" rel=\"external\">LibreOffice</a>, which is a fork of OpenOffice.org. They will both happily use all your existing office files in MS-Word, MS-Excel, and MS-PowerPoint format, and are really free (both as in freedom and as in price). And they run on Windows as well as on GNU/Linux."); ?></p>
