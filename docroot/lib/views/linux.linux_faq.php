  ...
  <div class="container">
    <article id="faq">
      ...
      <section>
        ...
        print _("Yes it does! We have built a website specially for that purpose, <a href=\"https://linuxpreloaded.com/\" title=\"GNU/Linux laptops\">LinuxPreloaded.com</a>, listing vendors that sell GNU/Linux desktops and laptops."); ?></p>
        <p><?php
      ...
      <section>
        ...
        <p><?php print _("There is a legal solution to play your DVDs on GNU/Linux where <code>libdvdcss</code> is illegal. The <a href=\"https://fluendo.com/\">Fluendo</a> company has developed an (non-free) application for that purpose which can be purchased from their website."); ?></p>
