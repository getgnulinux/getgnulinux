    ...
    <article id="faq">
      ...
      <section>
        ...
        <details>
            ...
            <?php print _("There is also a good selection of online game distribution platforms that sell many high-quality games for GNU/Linux, for example <a href=\"https://store.steampowered.com/linux\" rel=\"external\">Steam</a>, <a href=\"https://www.gog.com/games?system=lin_mint,lin_ubuntu&sort=popularity&page=1\" rel=\"external\">GOG</a>, <a href=\"https://itch.io/games/platform-linux\" rel=\"external\">itch.io</a>, and <a href=\"https://www.humblebundle.com/\" rel=\"external\">Humble Bundle</a>."); ?></p>
            <p><?php print _("Most popular games, alas, only work on Windows and occasionally on macOS. Some Windows games can be run on GNU/Linux with <a href=\"https://www.winehq.org/\" rel=\"external\">Wine</a> or its non-free variant <a href=\"https://www.codeweavers.com/crossover/\" rel=\"external\">CrossOver</a>, which involves some unpleasant effort for the user. For a list of games known to work on Wine, see <a href=\"https://appdb.winehq.org/\" rel=\"external\">their games database</a>. There is also Proton, a tool released by Valve Software that has been integrated with Steam Play to make playing Windows games on GNU/Linux as simple as hitting the Play button within Steam. For a list of games know to work on Proton, see <a href=\"https://www.protondb.com/\" rel=\"external\">their games database</a>."); ?></p>
            </blockquote>
        </details>
