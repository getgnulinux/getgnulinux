  ...
  <article>
    <div class="container">
      ...
      <section>
        ...
        print _("It is often difficult for Windows users to believe that there are <em>no spyware nor viruses</em> under GNU/Linux &mdash; <a href=\"http://linuxmafia.com/~rick/faq/#virus\">but it's true</a>. Malicious programs have a hard time doing anything at all in a well-built system."); ?></p>
      ...
      <section>
        ...
        <p><?php # translators: use localized Firefox landing page if possible
          print _("The Web looks just the same when viewed with GNU/Linux (in fact you can browse the Web with the same program if you already use <a href=\"https://www.getfirefox.com/\">Firefox</a> or <a href=\"https://www.google.com/chrome/\">Google Chrome</a>). And of course, you can go through your picture and music collection all the same. Files and folders are navigated with a file manager like Windows Explorer."); ?></p>
      </section>
