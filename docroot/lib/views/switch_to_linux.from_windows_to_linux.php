  ...
  <article>
    <div class="container">
      ...
      <section>
        ...
        <p><?php $p = _("It is often difficult for Windows users to believe that there are <em>no spyware nor viruses</em> under GNU/Linux &ndash; <a href=\"%s\">but it's true</a>. Malicious programs have a hard time doing anything at all in a well-built system.");
      ...
      <section>
        ...
        <p><?php print _("So, drivers are sometimes unavailable for the most recent high-end graphics cards &ndash; some are reverse-engineered from Windows drivers by volunteers. Some are also released free of charge, but under restrictive licenses."); ?></p>
