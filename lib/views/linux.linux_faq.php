...
<main role="main">
  <section id="faq">
    ...
    <div class="answer">
        <p><?php
        # translators: Use localized URL of free software definition on GNU.org in place of softwareliberty.com
        $p = _("No. There are a few <a href=\"https://www.softwareliberty.com/\">free software</a> components in Mac OS X, and it is technically similar to GNU/Linux systems. But overall, it is proprietary software: all the <a href=\"%s\">issues about Windows</a> apply to it as well."); printf($p, $this->base_url('windows',1)); ?></p>
    </div><!-- end answer -->
    </div><!-- end QA -->
    ...
    <div class="answer">
        ...
        <p><?php print _("Mac OS X does have some low-level components which are <a href=\"https://www.softwareliberty.com/\">free software</a>; and Apple puts less energy into customer lock-in (with some notable efforts such as BootCamp)."); ?><br />
    ...
    <div class="answer">
        <p><?php print _("No!"); ?></p>
        <p><?php print _("Wherever you read or heard this you should update your views. GNU/Linux is completely distinct from such things. Whether you want to do them, or whether you prefer <a href=\"https://www.magnatune.com/\">intelligent</a>, <a href=\"https://www.jamendo.com/\">legal downloads</a>, GNU/Linux will work just as well as Windows. Unfortunately you can't identify gangsters by the make of their cars; the same thing goes for their operating system."); ?></p>
    ...
    <div class="answer">
        ...
        print _("Yes it does! We have built a website specially for that purpose, <a href=\"https://linuxpreloaded.com/\" title=\"Linux laptops\">LinuxPreloaded.com</a>, listing vendors that sell GNU/Linux desktops and laptops."); ?></p>
        <p><?php
