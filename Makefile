...
LOCALES=ar_SA ast_ES ca_AD da_DK de_DE en_US eo es_ES fr_FR gl_ES he_IL hr_HR ia it_IT ja_JP ml_IN nl_NL pl_PL pt_BR pt_PT ru_RU sr_RS tr_TR uk_UA vi_VN zh_CN
