...
# Locales used by GGL.
locales=(ar_SA ast_ES bg_BG ca_AD da_DK de_DE en_US el_GR eo es_ES et_EE fi_FI
fr_FR gl_ES he_IL hr_HR ia id_ID it_IT ja_JP lt_LT mk_MK ml_IN nl_NL pl_PL
pt_BR pt_PT ru_RU sr_RS sv_SE tr_TR uk_UA uz_UZ vi_VN zh_CN zh_TW)
